...
\reaction*{ R^.  + O2 -> R-O-O^.  }
los cuales se convierten, reaccionando con el \ce{NO2} para formal alquilperoxinitratos\index{alquilperoxinitrato}  que 
\reaction*{ R-O-O^.  + NO2  ->  R-O-ONO2 }
son  un tipo de contaminantes atmosf\'ericos oxidantes.

\item[Ozono]\index{ozono!etileno} El mecanismo de reacci\'on del ozono en la formaci\'on 
de radicales es mas complicada. El ozono no extrae hidr\'ogenos de los
 compuestos org\'anicos. Mas com\'un, forma radicales mediante la creaci\'on con 
 hidrocarburos instaurados como el etileno o propileno, formando compuestos adicionados  
 con ox\'{\i}geno de acuerdo con
 
\begin{figure}[htbp]
\begin{center}
\begin{picture}(55,18)
% ozono
\put(-1,2){\ce{O3} + \ce{H2C\bond{2}CH2 -> } }
\put(36,2){\ce{CH2\bond{-}CH2}}
%
\put(36,5){\line(-1,2){2}}
\put(47,5){\line(1,2){2}}
% oxigenos
...
\put(48,10){\ce{O}}
%
\put(36,13){\line(5,3){4}}
\put(47,13){\line(-5,3){4}}
%
\put(40,15){\ce{O}}
\end{picture}
...
El fl\'uor (\ce{F}) y cloro (\ce{Cl}) reaccionan f\'acilmente de esta manera. Los \'atomos de bromo (\ce{Br}) pueden extraer un \'atomo de hidr\'ogeno solo del radical  \ce{HO2} o de los aldeh\'{\i}dos. Los \'atomos de yodo (\ce{I}) son menos reactivos. La alternativa de la reacci\'on anterior es la oxidaci\'on del \'atomo de hal\'ogeno (X=I, Cl, Br) por ozono:
\reaction{X + O3  -> XO^. + O2  \label{RH2} }
Debido a la reactividad decreciente de los hal\'ogenos, mientras que van de F a I, hacia compuestos que contiene H de la forma HX, la fracci\'on de \'atomos de hal\'ogenos libres que reaccionan en la ecuaci\'on \ref{RH2}, en contraposici\'on a \ref{RH1}, es \ce{F}$\sim$0\%,\ce{Cl}, 50\%, \ce{Br}, 99\%, \ce{I}, 100\%.
