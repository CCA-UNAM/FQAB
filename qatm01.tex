...
\begin{itemize}
    \item Formación: \ce{O2 + h$\nu$ -> 2O} seguido de \ce{O + O2 ->[M] O3 } $(\lambda < 242 \nano\metre)$
    \item Destrucción natural: \ce{O3 + h$\nu$  -> O2 + O} ~ $(\lambda < 310 \nano\metre)$
\end{itemize}

La \textbf{Sección 8.3} detalla los \textbf{ciclos de pérdida catalítica}, mecanismos aceleradores que explican el agotamiento observado desde 1980:
\begin{itemize}
    \item \textbf{Radicales hidroxilo} (8.3.1): Ciclo HO$_x$ con reacciones tipo \ce{HO^. + O3 -> HO2^. + O2}
    \item \textbf{Radicales de nitrógeno} (8.3.2): Ciclo NO$_x$ catalizado por \ce{NO^.} de origen natural y antropogénico
