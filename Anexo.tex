...
\begin{equation*}
\begin{split}
[H^+]^3 \left( 1 + \frac{HKP_{\ce{NH3}}}{Kw}\right)-&[H^+] (Kw + H_{\ce{CO2}} K_1 P_{\ce{CO2}} + H_{\ce{SO2}}K'_1 P_{\ce{SO2}})\\ &\quad -2 H_{\ce{CO2}}K_1K_2P_{\ce{CO2}} -2H_{\ce{SO2}}KÕ_1KÕ_2P_{\ce{SO2}} = 0
\end{split}
\end{equation*}
...
%         
%          \begin{equation*}
%         [H_3O^+]= [HCO_á^-]+2[CO_3^{2-}]+[OH^-]+[HSO_3^-]+2[SO_3^{2-}]
%         \end{equation}
%         
%          \begin{equation*}
