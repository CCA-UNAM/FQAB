...
\section {Demostración de pH de lluvia ácida}

Considerando que el agua también tiene un equilibrio tenemos la ecuación ~\ref{siete}, dando como resultado la siguiente ecuación:
\begin{equation*}
...
De acuerdo con la ecuación ~\ref{uno}, se sabe que:
\begin{equation*}
...
Para resolver una ecuación de tercer grado se sabe que:\\
...
Haciendo el cálculo para el más ácido\\
P$_{\ce{CO2}}$= 450ppm\\
P$_{\ce{NH3}}$= 0\\
P$_{\ce{SO2}}$= 150ppb\\
...
Haciendo el cálculo para el más alcalino\\
P$_{\ce{CO2}}$= 380ppm\\
P$_{\ce{NH3}}$=4 ppb \\
P$_{\ce{SO2}}$=0\\
