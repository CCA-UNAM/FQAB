\chapter{La energ\'{\i}a y las reacciones qu\'{\i}micas}
...
\subsubsection{Tipos de sistemas}
...
\subsubsection{Estado de un sistema}
...
\end{equation}
 ...
 \subsubsection{Ley General de los gases}
...
\subsection{Unidades empleadas en concentraciones atmosfŽricas}
 \index{unidades}
...
Debido a que las mezclas gaseosas se encuentran formadas por diferentes gases, se requiere de calcular el peso molecular de dicha composici\'on para lo cual se emplea el peso molecular promedio ($\overline{\textrm{M}}$) , \'este se obtiene de sumar los valores obtenidos de multiplicar la fracci\'on mol ($y_i$) de cada compuesto con su respectivo peso molecular ($\textrm{M}_i$),
\begin{equation}
...
\subexer  ?`Cu\'anto ser’a la concentraci—n de 0.090 ppm de ozono en \milli\gram / \cubic\metre ?
\exer Peso molecular promedio y densidad
\subexer ?`Cu\'al ser’a el peso molecular promedio del aire atmosfŽrico si se considera que tiene 21\% de ox’geno y 79\% de nitr—geno? 
\subexer ?`Cu\'al ser’a la densidad del aire a una temperatura de 20\celsius\, y 1 atm de presi—n ? 
\end{exercises}
...
Cuando $Q _{rev}$ es positivo, es decir hay absorci\'on de calor, entonces tambi\'en \gloss[word]{deltas} es positiva, indicando un incremento en la entrop\'{\i}a del sistema. Por otra parte cuando hay desprendimiento de calor $Q _{rev}$ es negativa y lo es $\Delta S$, y el
...
\paragraph{Cambios de entrop\'{\i}a en las reacciones qu\'{\i}micas}
...
\paragraph{\gloss[Word]{endergonicas}}\index{reaccion@reacci\'on!enderg\'onica} Aquellas
reacciones bioqu\'{\i}micas que para ocurrir requieren de energ\'{\i}a proveniente de enlaces
de alta energ\'{\i}a como el ATP.

\paragraph{\gloss[Word]{exergonicas}}\index{reaccion@reacci\'on!exerg\'onica} Aquellas reacciones
