...
\usepackage{babel} % Importante para Espa\~nol
...
\renewcommand{\spanishcontentsname}{\textrm{\'Indice general}}
\renewcommand{\spanishchaptername}{\textrm{Cap\'{\i}tulo}}
\renewcommand{\spanishindexname}{\textrm{\'Indice alfab\'etico}}
...
%% Add your info here:
\offprintinfo{Procesos y Reacciones Atmosf\'ericas,\\ Primera Edici\'on}{Agustin Garc\'{\i}a }
...
\begin{copyrightpage}{2025}
 Procesos y Reacciones Atmosf\'ericas/ Jos\'e Agust\'{\i}n Garc\'{\i}a Reynoso
\    Incluye referencias bibliogr\'aficas e \'{\i}ndice.\vskip8pt
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \acro{COV}{Compuestos Org\'anicos Vol\'atiles.}
  ...
  \acro{DU}{unidades Dobson, del ingl\'es}
 \acro{FEM}{Fuerza electro motriz}
 \acro{HAP}{Hidrocarburos Policiclicos Arom\'aticos.} 
 \acro{IR}{Infrarrojo}
 ...
 \acro{NMVOC}{Compuestos org\'anicos No metano} 
 ...
 \acro{PSC}{Nubes estratosf\'ericas polares del ingl\'es.}
